...
using GoldDiff.Shared.View.Effect.Acrylic.Native;

namespace GoldDiff.Shared.View.Effect.Acrylic
{
    // Taken from https://gist.github.com/walterlv/752669f389978440d344941a5fcd5b00
    public class WindowBlur
    {
        ...
        public static readonly DependencyProperty WindowBlurProperty = DependencyProperty.RegisterAttached("WindowBlur", typeof(WindowBlur), typeof(WindowBlur),
